...
Maintenant que nous avons de la donnée, le Board veut un "Data Quality Report". Nous allons utiliser connaissances (SELECT, JOIN, WHERE) pour sortir les listes suivantes:
<br>
